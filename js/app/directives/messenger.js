 ...
 */
define(['modules/App','directives/tabs','directives/businessCard','services/userService','directives/messageReminder','directives/chatBox'],function(app){
    app.directive('messenger',function($q,$rootScope,$compile,userService,$interval){
       return {
           restrict: "A",
